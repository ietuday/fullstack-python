...
#
# An IP address consists of 4 numbers, separated from each other with a period. But
...
#
# Once you have a working program, there are some more suggestions for invalid input to test:
#    .123.45.678.91
#    123.4567.8.9.
